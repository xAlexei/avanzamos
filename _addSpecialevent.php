    ...
    <div class="page-content">
        <div class="card card-style">
            <div class="content mb-0">        
                ...
                <!--Nombre del evento -->
                <br><form action="_addSpecial.php" method="POST">
                    <div class="input-style input-transparent has-borders validate-field mb-4">
                        <input type="text" class="form-control validate-name" name="eventname" placeholder="Nombre del evento" required>
                ...
                <div class="input-style has-borders no-icon mb-4">
                    <textarea id="description" name="description" placeholder="Descripcion del evento"></textarea>
                    <label for="form7" class="color-highlight">Descripcion del evento</label>
                    <em class="mt-n3">(required)</em>
                </div>
                <!--Ubicacion -->
                <div class="input-style input-transparent has-borders validate-field mb-4">
                        <input type="text" class="form-control validate-name" name="ubication" placeholder="Punto de encuentro" required>
