        ...
        <div class="card card-style">
            <div class="content mb-2">
                ...
                <table class="table table-borderless text-center rounded-sm shadow-l" style="overflow: hidden;">
                    ...
                    <tbody>
                        <?php                         
                        $query = "SELECT _idMeet, meetName, fecha FROM meetings ORDER BY fecha ASC";
                        $res = mysqli_query($link, $query);
                        while($row = mysqli_fetch_array($res)):
                        ?>
                        <tr>
                            <th scope="row"><?php echo $row['meetName']?></th>
                            <th scope="row"><?php echo $row['fecha']?></th>
                            <td>
                            <a href="_editarreunionForm.php?id=<?php echo $row['_idMeet']?>"><i class="fa-solid fa-pen-to-square"></i></a>
                            <a href="_eliminarReunion.php?id=<?php echo $row['_idMeet']?>"><i class="fa-solid fa-trash" style="color: #eb0a0a;"></i></a>
                            </td>
                        </tr>
                        <?php
                        endwhile;
